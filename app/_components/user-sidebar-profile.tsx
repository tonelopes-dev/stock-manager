...
export const UserSidebarProfile = async () => {
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-4 border-b border-gray-100 mb-2">
      <div className="flex h-9 w-9 items-center justify-center rounded-full bg-primary/10 text-primary font-bold text-xs ring-2 ring-white shadow-sm">
        {initials}
      </div>
