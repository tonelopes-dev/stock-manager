...
const CardapioPage = async ({ searchParams }: ProductsPageProps) => {
...
const ProductTableWrapper = async ({
  ...
  // Filter for Cardápio: All except inputs
  const productsPromise = getProducts(30, status, environmentId, [
    ProductType.REVENDA,
    ProductType.PRODUCAO_PROPRIA,
    ProductType.COMBO,
  ]);
  ...
  return (
    <div className="space-y-6">
      <Header>
        <HeaderLeft>
          <HeaderSubtitle>Gestão do Menu Comercial</HeaderSubtitle>
