  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
      ...
      <div className="group relative flex h-full flex-col justify-between overflow-hidden rounded-xl border border-orange-200 bg-gradient-to-br from-orange-50/40 via-background to-background p-5 transition-all duration-200 ease-out hover:-translate-y-0.5 hover:border-orange-400 hover:shadow-md hover:shadow-orange-500/10">
        ...
        <Link href="/sales?tab=pendentes" className="absolute inset-0 z-0 outline-none" aria-label="Ver títulos em aberto" />
            ...
            <div className="pointer-events-auto">
              <Popover>
                ...
                <PopoverContent
                  side="top"
                  align="end"
                  className="max-w-[240px] border-foreground bg-foreground text-[11px] font-medium leading-relaxed text-background shadow-xl z-50"
                >
        ...
        <p className="mt-1 text-xs font-medium text-orange-600/80 group-hover:text-orange-600 group-hover:underline relative z-10 pointer-events-none">
          Ver títulos em aberto ↗
        </p>

        <div className="absolute bottom-0 left-0 h-[2px] w-0 bg-gradient-to-r from-orange-500 to-amber-400 transition-all duration-300 group-hover:w-full z-10 pointer-events-none" />
      </div>
    </div>
  );
};
